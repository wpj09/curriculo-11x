<section class="dash_content_app">
    ...
    <header class="dash_content_app_header">
        <h2 class="icon-search">Cadastrar Novo Currículo</h2>
        ...
        <div class="dash_content_app_header_actions">
            <nav class="dash_content_app_breadcrumb">
                <ul>
                    ...
                    <li class="separator icon-angle-right icon-notext"></li>
                    <li><a href="" class="text-orange">Cadastrar Currículo</a></li>
                </ul>
            </nav>
                ...
                <div id="parts">
                    <form action="" method="post" class="app_form">
                        ...
                        <div class="app_collapse">
                            ...
                            <div class="app_collapse_content">
                                ...
                                <div class="label_g2">
                                    ...
                                    <label class="label">
                                        <span class="legend">Prazo do Currículo (Em meses)</span>
                        ...
                        <div class="text-right mt-2">
                            <button class="btn btn-large btn-green icon-check-square-o">Salvar Currículo</button>
                        </div>
                    </form>
                </div>
