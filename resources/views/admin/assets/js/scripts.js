$(function () {
    ...
    function normalizeSpouse() {
        if (typeof ($('select[name="civil_status"]')) !== 'undefined') {
            if ($('select[name="civil_status"]').val() === 'Casado') {
    ...
    //         $('input[name="tribute"]').attr('disabled', false);
    //         $('input[name="condominium"]').attr('disabled', false);
    //         $('select[name="deadline"]').prop('disabled', false);
    //         $('select[name="due_date"]').prop('disabled', false);
    //         $('input[name="start_at"]').attr('disabled', false);
    //     } else {
    //         $('input[name="sale_price"]').attr('disabled', true);
    //         $('input[name="tribute"]').attr('disabled', true);
    //         $('input[name="condominium"]').attr('disabled', true);
    //         $('select[name="deadline"]').prop('disabled', true);
    //         $('select[name="due_date"]').prop('disabled', true);
    //         $('input[name="start_at"]').attr('disabled', true);
    //     }
    // });
